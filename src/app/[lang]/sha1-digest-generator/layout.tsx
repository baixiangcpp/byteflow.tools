...
const TITLE = "SHA-1 Digest Generator"
const DESCRIPTION = "Generate SHA-1 digests locally for compatibility checks. SHA-1 is weak for security-sensitive use cases."
const KEYWORDS = ["sha1 hash", "sha1 generator", "sha1 digest generator", "sha1 checksum"]
