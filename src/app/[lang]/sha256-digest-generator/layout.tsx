...
const TITLE = "SHA-256 Digest Generator"
const DESCRIPTION = "Generate SHA-256 digests with text, file hashing, and HMAC quick mode in a focused single-algorithm workflow."
const KEYWORDS = ["sha256 hash", "sha256 generator", "sha256 hmac", "sha256 checksum tool"]
