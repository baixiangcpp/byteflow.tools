...
const TITLE = "SHA-384 Digest Generator"
const DESCRIPTION = "Generate SHA-384 digests locally in your browser for checksum, signature, and integrity workflows."
const KEYWORDS = ["sha384", "sha-384 hash", "sha384 generator", "online hash tool"]
