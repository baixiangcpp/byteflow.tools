...
const WORKFLOW_SLUG = "security-token-review" satisfies WorkflowSlug
...
export default async function SecurityTokenReviewWorkflowPage({ params }: { params: Promise<{ lang: string }> }) {
    const { lang } = await params
    if (!isValidLocale(lang)) {
        notFound()
    }
