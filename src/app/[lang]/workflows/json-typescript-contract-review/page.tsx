...
const WORKFLOW_SLUG = "json-typescript-contract-review" satisfies WorkflowSlug
...
export default async function JsonTypescriptContractReviewWorkflowPage({ params }: { params: Promise<{ lang: string }> }) {
    const { lang } = await params
    if (!isValidLocale(lang)) {
        notFound()
    }
