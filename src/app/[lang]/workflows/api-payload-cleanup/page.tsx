...
const WORKFLOW_SLUG = "api-payload-cleanup" satisfies WorkflowSlug
...
export default async function ApiPayloadCleanupWorkflowPage({ params }: { params: Promise<{ lang: string }> }) {
    const { lang } = await params
    if (!isValidLocale(lang)) {
        notFound()
    }
