...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return buildToolMetadata({ lang, slug: "image-privacy-workbench" });
}
...
export default async function Layout({ children, params }: { children: React.ReactNode; params: Promise<{ lang: string }> }) {
    ...
    return (
        <>
            <ToolBreadcrumbJsonLd lang={lang} slug="image-privacy-workbench" />
            {children}
            <ToolContentTemplateServer toolSlug="image-privacy-workbench" lang={lang} />
        </>
    );
}
