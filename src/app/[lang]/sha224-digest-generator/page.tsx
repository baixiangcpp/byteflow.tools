...
const FALLBACK_TITLE = "SHA-224 Digest Generator"
const FALLBACK_DESCRIPTION = "Generate SHA-224 digests in a focused workflow. SHA-224 is a one-way hash function and cannot be reversed."
const OUTPUT_LABEL_BY_LOCALE: Record<Locale, string> = {
    ...
    ko: "SHA-224 다이제스트",
    de: "SHA-224-Digest",
    fr: "Empreinte SHA-224",
}
const OUTPUT_PLACEHOLDER_BY_LOCALE: Record<Locale, string> = {
    en: "SHA-224 digest will appear here",
    "zh-CN": "SHA-224 摘要将显示在这里",
    "zh-TW": "SHA-224 摘要將顯示在這裡",
    ja: "SHA-224 ダイジェストがここに表示されます",
    ko: "SHA-224 다이제스트가 여기에 표시됩니다",
    de: "SHA-224-Digest wird hier angezeigt",
    fr: "L'empreinte SHA-224 s'affichera ici",
}

export default async function Sha224EncryptDecryptPage({
    params,
}: {
