...
export function PipelineBuilderPage() {
    ...
    const actions: ToolAction[] = [
        ...
        { id: "run", label: isRunning ? text("running") : text("run_recipe"), icon: Play, onClick: runCurrentRecipe, disabled: isRunning || recipe.steps.length === 0 },
    ...
    return (
        <WideToolPageContainer className="flex flex-col gap-6 py-8">
            ...
            <PipelinePrivacyPreview
                action={privacyPreviewAction}
                closeLabel={t.common.close}
                onCancel={cancelPrivacyPreview}
                onCloseAutoFocus={restorePrivacyReturnFocus}
            ...
            <div data-input-intent="workbench" className="grid gap-4 lg:grid-cols-[340px_minmax(0,1fr)_360px]">
                ...
                <main className="space-y-4">
                    ...
                    <PipelineStepDiagnostics
                        ...
                        text={text}
                    />
                    <PipelineUsageGuide maxSteps={recipe.settings.maxSteps} text={text} />
                </main>
                ...
                <PipelineStepInspector
                    ...
                    onExportRecipe={() => {
                        requestPrivacyPreview("export", true)
                    }}
